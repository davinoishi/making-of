...
- **Update it at the end of every working session**, before wrapping up — not only
  ...
  doesn't get re-litigated in six months because nobody remembers the reasoning.2. Seed MAKING-OF.md with this header
# Making of <project>
...
claude config  # not available here — edit .claude/settings.json directlyAdd a Stop hook that echoes a reminder to update MAKING-OF.md before the session closes. I can wire that up for one of your projects as a reference implementation if you want something to hand them.
